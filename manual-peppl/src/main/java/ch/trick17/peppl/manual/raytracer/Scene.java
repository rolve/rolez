...
public class Scene extends ImmutableObject {
    
    public final ImmutableArray<Light> lights;
    public final ImmutableArray<Primitive> objects;
    public final View view;
    
    public Scene(final Light[] lights, final Primitive[] objects,
            final View view) {
        this.lights = new ImmutableArray<Light>(lights.clone());
        this.objects = new ImmutableArray<Primitive>(objects.clone());
        this.view = view;
    }
