...
public class MainTaskInnerClassConstructor extends SootMethod {

	static final Logger logger = LogManager.getLogger(MainTaskInnerClassConstructor.class);
	...
	public MainTaskInnerClassConstructor(SootClass containingClass, SootClass outerClass) {
