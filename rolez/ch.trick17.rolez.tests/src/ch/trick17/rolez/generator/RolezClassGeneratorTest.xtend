...
class RolezClassGeneratorTest {
    
    @Inject extension ParseHelper<Program>
    @Inject extension ValidationTestHelper
    @Inject extension TestUtils
    
    @Inject extension RolezClassGenerator classGenerator
    ...
    private def onlyClass(Program it) {
        assertNoErrors
    ...
    private def someClassesCompiled() {
